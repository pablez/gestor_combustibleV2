...
class UnidadTransporteFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'id_tipo_vehiculo' => \App\Models\TipoVehiculo::first()?->id ?? \App\Models\TipoVehiculo::factory()->create()->id,
            'id_tipo_combustible' => \App\Models\TipoCombustible::first()?->id ?? \App\Models\TipoCombustible::factory()->create()->id,
            ...
            'id_unidad_organizacional' => \App\Models\UnidadOrganizacional::first()?->id_unidad_organizacional ?? \App\Models\UnidadOrganizacional::factory()->create()->id_unidad_organizacional,
