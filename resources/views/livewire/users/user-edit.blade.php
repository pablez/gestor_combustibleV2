        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200">Editar Usuario</h2>
                        <p class="text-gray-600 dark:text-gray-400 mt-1">Modificar información de: <span class="font-medium">{{ $user->full_name }}</span></p>
                    </div>
                ...
                <form wire:submit="update" class="space-y-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-shrink-0">
                                @if ($profile_photo)
                                    ...
                                    <img src="{{ $profile_photo->temporaryUrl() }}" 
                                         alt="New preview" 
                                         class="h-20 w-20 rounded-full object-cover border-2 border-green-300">
                                @elseif ($user->profile_photo_url && !$remove_photo)
                                    {{-- Current photo --}}
                            ...
                            <div class="flex-1">
                                <input wire:model="profile_photo" 
                                       type="file" 
                                       accept="image/*"
                                       class="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100 mb-2">
                                
                                @if($user->profile_photo_path && !$remove_photo && !$profile_photo)
                                    <button type="button" 
                                ...
                                @if($remove_photo)
                                    <p class="text-sm text-red-600">La foto actual será eliminada al guardar.</p>
                                @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Deja en blanco si no deseas cambiar la contraseña</p>
                        </div>
