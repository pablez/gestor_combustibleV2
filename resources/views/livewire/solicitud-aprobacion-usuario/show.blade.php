    ...
    @if($mostrarModalAprobacion)
        <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <!-- Overlay -->
                <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" wire:click="cerrarModalAprobacion"></div>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full sm:mx-0 sm:h-10 sm:w-10
                                {{ $accionSeleccionada === 'aprobar' ? 'bg-green-100' : 'bg-red-100' }}">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        ¿Estás seguro de que deseas {{ $accionSeleccionada === 'aprobar' ? 'aprobar' : 'rechazar' }} 
                                        esta solicitud de {{ $solicitud->usuario->name }}?
                                    </p>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea wire:model="observacionesAprobacion" 
